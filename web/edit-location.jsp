...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <form action="updateLocation" id="set-date" method="POST">
                ...
                <div class="margin_60 container">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<s:property value="loc.text"/>" name="locName" id="locName" type="text"  required>
                            <s:hidden name="locId" value="%{loc.value}"/>
